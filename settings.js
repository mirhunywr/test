...
module.exports = {
  ...
  BOT_NAME: process.env.BOT_NAME || getConfig("BOT_NAME") || "QADEER-AI", // Bot display name
  MODE: getConfig("MODE") || process.env.MODE || "private", // Bot mode: public/private/group/inbox
  REPO: process.env.REPO || "https://github.com/QadeerXTech/QADEER-AI", // Bot GitHub repo dont change this❗️
  BAILEYS: process.env.BAILEYS || "@whiskeysockets/baileys", // Baileys version

  // ===== OWNER & DEVELOPER SETTINGS =====
  OWNER_NUMBER: process.env.OWNER_NUMBER || "923300005253", // Owner WhatsApp number
  OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "QADEER BRAHVI", // Owner name
  DEV: process.env.DEV || "923300005253", // Developer contact number
  DEVELOPER_NUMBER: '923300005253@s.whatsapp.net', // Developer WhatsApp ID
  ...
  ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/hvw9w3.jpg",
// add img for alive msg

  LIVE_MSG: process.env.LIVE_MSG || "> ʙᴏᴛ ɪs sᴘᴀʀᴋɪɴɢ ᴀᴄᴛɪᴠᴇ ᴀɴᴅ ᴀʟɪᴠᴇ\n\n\nᴋᴇᴇᴘ ᴜsɪɴɢ ✦ϙᴀᴅᴇᴇʀ ᴀɪ✦ ғʀᴏᴍ sung ᴛᴇᴄʜ ɪɴᴄ⚡\n\n\n*© ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ - ᴍᴅ\n\n> ɢɪᴛʜᴜʙ :* github.com/QadeerXTech/QADEER-AI",
// add alive msg here 
  ...
  STICKER_NAME: process.env.STICKER_NAME || "ϙᴀᴅᴇᴇʀ-ᴀɪ", // Sticker pack name
  ...
  MENU_IMAGE_URL: getConfig("MENU_IMAGE_URL") || "https://files.catbox.moe/hvw9w3.jpg", // Menu image URL
  ...
  DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ϙᴀᴅᴇᴇʀ-ᴀɪ*", // Bot description/footer
